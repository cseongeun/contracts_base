...
import { IKIP37 } from "./interfaces/IKIP37.sol";
import { IKIP37Receiver } from "./interfaces/IKIP37Receiver.sol";
import { IERC1155Receiver } from "./interfaces/IERC1155Receiver.sol";
import { IKIP37MetadataURI } from "./interfaces/IKIP37MetadataURI.sol";
...
import { KIP37Feature } from "./KIP37Feature.sol";
...
contract KIP37 is KIP13, IKIP37, IKIP37MetadataURI, Context, KIP37Feature {
  ...
  function balanceOf(address account, uint256 id)
    ...
    returns (uint256)
  {
    require(account != address(0), "KIP37: address zero is not a valid owner");
