...
import { IKIP17 } from "./interfaces/IKIP17.sol";
import { IKIP17Receiver } from "./interfaces/IKIP17Receiver.sol";
import { IERC721Receiver } from "./interfaces/IERC721Receiver.sol";
import { IKIP17Metadata } from "./interfaces/IKIP17Metadata.sol";
...
import { KIP17Feature } from "./defaults/KIP17Feature.sol";
...
contract KIP17 is KIP13, Context, IKIP17, IKIP17Metadata, KIP17Feature {
    ...
    returns (address)
  {
    ...
    require(owner != address(0), "KIP17: invalid token ID");
    return owner;
  }
  ...
  function _requireMinted(uint256 tokenId) internal view virtual {
    require(_exists(tokenId), "KIP17: invalid token ID");
  }
  ...
  function _checkOnKIP17Received(
    ...
    if (to.isContract()) {
      ...
      returns (bytes4 retval) {
        ...
        if (reason.length == 0) {
          revert("KIP17: transfer to non KIP17Receiver implementer");
        } else {
          assembly {
