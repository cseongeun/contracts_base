...
abstract contract BEP1155Freezable is BEP1155 {
  /**
   * @dev user freezed
   * */
  ...
  function _beforeTokenTransfer(
    ...
    require(!freezed[from], "BEP1155Freezable: from freezed");
    require(!freezed[_msgSender()], "BEP1155Freezable: sender freezed");
  }
}
