...
import { IBEP1155 } from "./interfaces/IBEP1155.sol";
import { IBEP1155Receiver } from "./interfaces/IBEP1155Receiver.sol";
import { IBEP1155MetadataURI } from "./interfaces/IBEP1155MetadataURI.sol";
 ...
 * Originally based on code by Enjin: https://github.com/enjin/BEP-1155
 *
  ...
  BEP1155Feature
{
    ...
    returns (uint256)
  {
    require(
      account != address(0),
      "BEP1155: address zero is not a valid owner"
    );
  ...
  function safeTransferFrom(
    ...
    require(
      ...
      "BEP1155: caller is not token owner nor approved"
    );
  ...
  function _doSafeTransferAcceptanceCheck(
    ...
    if (to.isContract()) {
      try
        IBEP1155Receiver(to).onBEP1155Received(operator, from, id, amount, data)
