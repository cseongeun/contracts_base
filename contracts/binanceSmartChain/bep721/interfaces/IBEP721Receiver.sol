...
// OpenZeppelin Contracts (last updated v4.6.0) (token/BEP721/IBEP721Receiver.sol)
...
interface IBEP721Receiver {
     ...
     *
     * The selector can be obtained in Solidity with `IBEP721Receiver.onBEP721Received.selector`.
     */
